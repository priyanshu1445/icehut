...
const About = () => {
  ...
  return (
    <div>
      ...
      {/* Hero Section */}
      <div
        className="relative w-full h-[80vh] bg-cover bg-center bg-fixed flex items-center justify-center"
        style={{
      ...
      <div className="px-4 py-10 bg-gray-50">
        <div className="max-w-7xl mx-auto text-center" data-aos="fade-up">
          ...
          <h2 className="text-3xl md:text-5xl font-bold mb-6">
            We are a part of <br />
            <span className="text-green-500">Digitally-Fluent Workforce</span>
          </h2>
        ...
        >
          ...
          <div className="w-full md:w-3/4 text-center md:text-left">
            <h2 className="text-2xl md:text-5xl text-green-500 font-bold mb-4">Who we are?</h2>
        ...
        >
          <div className="w-full md:w-3/4 text-center md:text-right order-2">
            <h2 className="text-2xl md:text-5xl text-green-500 font-bold mb-4">Curious About Our Origin?</h2>
            <p className="text-gray-600 text-sm md:text-base">
        ...
        >
          ...
          <div className="w-full md:w-3/4 text-center md:text-left">
            <h2 className="text-2xl md:text-5xl text-green-500 font-bold mb-4">How do we do it?</h2>
            <p className="text-gray-600 text-sm md:text-base">
